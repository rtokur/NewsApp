...
import { ReadingHistoryListResponseDto } from './dto/reading-history-list-response.dto';
  ...
  export class ReadingHistoryController {
    constructor(
      private readonly service: ReadingHistoryService,
    ) {}
    ...
    @ApiResponse({ status: 200, description: 'The news article has been removed from reading history successfully', schema: { example: { success: true } } })
    remove(
      @CurrentUser() user: JwtPayload,
